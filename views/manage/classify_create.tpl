...
{% block content %}
  <div class="content">
    ...
    <div class="info-list">
      <input id="new-name" class="info-item" type="text" name="name" placeholder="分类名称" value="{{classify.name}}">
      <button id="create-btn" class="save" data-id="{{classify.id}}">添加</button>
    </div>
  </div>
{% endblock %}
